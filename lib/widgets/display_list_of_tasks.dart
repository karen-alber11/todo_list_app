...
class DisplayListOfTasks extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final emptyTasksAlert = isCompletedTasks ? 'There is no completed task yet' : 'There is no task to do!';
          ...
          return InkWell(
            ...
            child: TaskTile(
              ...
              onDelete: () async {
                ...
                ref.refresh(taskRepositoryProvider);
              },
            ),
          );
        },
